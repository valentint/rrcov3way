...
\SweaveOpts{prefix.string=images/rrcov3way}
\SweaveOpts{width=60}
...
<<label=intro-parafac-rob>>=
(resr <- Parafac(elind, ncomp = 3, robust = TRUE))
@
\begin{figure}[H]
\centering
<<label=intro-parafac-dd, fig=TRUE, include=TRUE, width=14, height=7>>=
...
\begin{figure}[H]
\centering
<<label=intro-parafac-comp, fig=TRUE, include=TRUE, width=14, height=7>>=
oldpar <- par(mfrow = c(1,2))
...
<<label=robust-pca, fig=TRUE, include=FALSE, width=6, height=6>>=
data("elind")
...
@
From this table we can see that the solution with all relative weights equal to 3 is
...
sum(X ^ 2)
@
<<label=girls-average-plot, fig=TRUE, include=FALSE, width=7, height=5>>=
p <- ncol(average.girl)
...
<<label=girls-ddplot, fig=TRUE, include=FALSE, width=14, height=7, echo=FALSE, results=hide>>=
oldpar <- par(mfrow = c(1, 2))
...
<<label=girls-paired, fig=TRUE, include=FALSE, width=14, height=7>>=
oldpar <- par(mfrow = c(1, 2))
...
\end{figure}
<<label=girls-paired-B, fig=TRUE, include=FALSE, width=14, height=7>>=
oldpar <- par(mfrow = c(1, 2))
...
<<label=girls-percomp, fig=TRUE, include=FALSE, width=7, height=7>>=
...
<<label=girls-allcomp, fig=TRUE, include=FALSE, width=8, height=5>>=
...
<<label=amino-allcomp, fig=TRUE, include=FALSE, width=8, height=5>>=
data("amino")
...
<<label=girls-jointbiplot, fig=TRUE, include=FALSE, width=7, height=7>>=
...
(like girls 9 and 11).
<<label=girls-tjplot, fig=TRUE, include=FALSE, width=7, height=7>>=
...
<<label=girls-tjplot2, fig=TRUE, include=FALSE, width=7, height=7>>=
...
<<label=Kojima-Parafac-postprocess>>=
...
\begin{figure}[H]
\centering
<<label=Kojima-percomp, fig=TRUE, include=TRUE, width=7, height=7>>=
...
<<label=Arno-t3-comp-modeA, fig=TRUE, include=FALSE, width=8, heigth=5>>=
plot(Arnot3, which = "comp", main = "(a) Paired component plot (mode A)")
@
<<label=Arno-t3-comp-modeB, fig=TRUE, include=FALSE, width=8, heigth=5>>=
...
<<label=Arno-t3-comp-joint, fig=TRUE, include=FALSE, width=8, heigth=5>>=
...
<<label=Arno-t3-comp-trajectory, fig=TRUE, include=FALSE, width=8, heigth=5>>=
...
<<label=amino-surface, fig=TRUE, include=FALSE, width=8, height=8>>=
data("amino")
...
<<label=amino-excitation, fig=TRUE, include=FALSE, width=8, height=8>>=
library("ggplot2")
library("reshape2")
...
@
<<label=amino-PARAFAC-nonneg, fig=TRUE, include=FALSE, width=7, height=5>>=
plot(p1, which = "allcomp", mode = "B", points = FALSE,
    legend.position = NULL, xlab = "Wavelength",
    main = "(b)")
@
<<label=amino-PARAFAC-none, fig=TRUE, include=FALSE, width=7, height=5>>=
